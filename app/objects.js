...
let goodDoggo = {
  ...
  legs: 4,
  tail: true,
  likes: ["gaming", "sleeping", "eating", "coding"]
...
function renameCat() {cat["name"] = "Kevin"; return cat["name"]
...
function colorTheCat() {cat["color"] = "Purple"; return cat["color"]
  // your code inside here
}
...
function returnIndex(cat) {return cat.likes[3]
  // your code inside here
}